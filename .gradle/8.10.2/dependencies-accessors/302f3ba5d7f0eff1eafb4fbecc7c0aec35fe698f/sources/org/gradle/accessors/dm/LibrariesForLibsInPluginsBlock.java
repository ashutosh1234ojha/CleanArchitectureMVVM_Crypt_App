...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory {
        private final DaggerHildLibraryAccessors laccForDaggerHildLibraryAccessors = new DaggerHildLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>dagger.hild</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public DaggerHildLibraryAccessors getHild() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForDaggerHildLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class DaggerHildLibraryAccessors extends SubDependencyFactory {
        private final DaggerHildAndroidLibraryAccessors laccForDaggerHildAndroidLibraryAccessors = new DaggerHildAndroidLibraryAccessors(owner);

        public DaggerHildLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>dagger.hild.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public DaggerHildAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForDaggerHildAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class DaggerHildAndroidLibraryAccessors extends SubDependencyFactory {

        public DaggerHildAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("dagger.hild.android.compiler");
        }
    ...
    public static class SquareupOkhttp3LibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getInterceptor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("squareup.okhttp3.interceptor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltCompiler</b> with value <b>2.37</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class DaggerHiltAndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>dagger.hilt.android.gradle</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGradle() { return createPlugin("dagger.hilt.android.gradle"); }
